...
<section class="resumen">
    <div class="resumen__grid">
        ...
        <div class="resumen__bloque">
            <p class="resumen__texto resumen__texto--numero"><?php echo $totalRegistrados ?></p>
        ...
        <?php foreach ($ponentes as $ponente) : ?>
            <div class="speaker">
                <picture>
                    ...
                    <img class="speaker__imagen" src="/public/img/speakers/<?php echo $ponente->imagen; ?>.png" alt="Imagen Ponente">
                </picture>
