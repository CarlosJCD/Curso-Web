...
class Email
{
    ...
    private function construirEmailConfirmarCuenta(PHPMailer $mail)
    {
        ...
        $mail->Body .= "<a href='http://appsalon.localhost/confirmarCuenta?token=" . $this->token . "'> Confirmar Cuenta";
        $mail->Body .= "</a></p>";
        $mail->Body .= "</html>";
    }
    ...
    private function construirEmailCambiarContraseña(PHPMailer $mail)
    {
        ...
        $mail->Body .= "</p>";
        $mail->Body .= "<p>presiona aquí:";
        $mail->Body .= "<a href='http://appsalon.localhost/cambiarContraseña?token=" . $this->token . "'> Cambiar Contraseña";
        $mail->Body .= "</a></p>";
        $mail->Body .= "</html>";
    }
}
